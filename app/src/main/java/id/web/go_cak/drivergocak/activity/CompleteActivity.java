...
//
//    ArrayList<HashMap<String, String>> completeList;
//
//    // products JSONArray
...
//        HashMap<String, String> itemValue = completeList.get(position);
...
//     * */
//    class LoadComplete extends AsyncTask<String, String, String> {
//
//        /**
...
//            super.onPreExecute();
//            pDialog = new ProgressDialog(CompleteActivity.this);
...
//                            CompleteActivity.this, completeList,
...
//        super.onBackPressed();
//        Intent sendIntent = new Intent(CompleteActivity.this, MainActivity.class);
